...
public class PokejungeAxe extends Item {

	public PokejungeAxe() {
		setRegistryName("pokejungeaxe");        // The unique name (within your mod) that identifies this item
		setUnlocalizedName(Ref.MODID + ".pokejungeaxe");     // Used for localization (en_US.lang)
